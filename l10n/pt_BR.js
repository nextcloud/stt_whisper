OC.L10N.register(
    ...
    "Could not execute the FFmpeg executable. You may need to set the path to a working executable manually in the \"Whisper Speech-To-Text app\" section of the admin settings." : "Não foi possível executar o executável FFmpeg. Pode ser necessário definir o caminho para um executável funcional manualmente na seção \"Aplicativo Whisper Speech-To-Text\" das configurações de administrador.",
    "Could not execute the Whisper executable. You may need to compile Whisper yourself for it to run on this server's processor architecture." : "Não foi possível executar o executável do Whisper. Pode ser necessário compilar o Whisper para que ele seja executado na arquitetura do processador deste servidor.",
    "It seems that your server processor does not support AVX instructions. Without AVX instructions Whisper app currently does not work." : "Parece que o processador do seu servidor não suporta instruções AVX. Sem instruções AVX, o aplicativo Whisper atualmente não funciona.",
    "Whisper Speech-To-Text app binary files are present" : "Arquivos binários do aplicativo Whisper Speech-To-Text estão presentes",
    "Whisper Speech-To-Text models are downloaded" : "Os modelos Whisper Speech-To-Text são baixados",
    "Whisper Speech-To-Text models are not downloaded, please run `occ stt_whisper:download-models [small%1$smedium%1$slarge]` to download them" : "Os modelos Whisper Speech-To-Text não foram baixados, execute `occ stt_whisper:download-models [small %1$s medium %1$s large]` para baixá-los",
    ...
    "Could not execute the FFmpeg executable. You may need to set the path to a working executable manually. (See below.)" : "Não foi possível executar o executável FFmpeg. Pode ser necessário definir manualmente o caminho para um executável funcional. (Veja abaixo.)",
    "Could not execute the Whisper executable. You may need to compile whisper yourself for it to run on this server's processor architecture." : "Não foi possível executar o executável Whisper. Pode ser necessário compilar você mesmo para que ele seja executado na arquitetura do processador deste servidor.",
    ...
    "Could not execute the shipped FFmpeg executable. You may need to set the path to a working binary manually." : "Não foi possível executar o executável FFmpeg enviado. Você pode precisar definir o caminho para um binário funcional manualmente.",
    "FFmpeg executable was installed successfully and works." : "O executável FFmpeg foi instalado com sucesso e funciona.",
    "If the shipped FFmpeg executable doesn't work on your system for some reason you can set the path to a custom FFmpeg executable. Leave this empty to use the shipped executable." : "Se o executável FFmpeg enviado não funcionar em seu sistema por algum motivo, você pode definir o caminho para um executável FFmpeg personalizado. Deixe em branco para usar o executável enviado.",
