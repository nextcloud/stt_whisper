OC.L10N.register(
    ...
    "It seems that your server processor does not support AVX instructions. Without AVX instructions this app currently does not work." : "Схоже, що процесор вашого сервера не підтримує інструкції AVX. Без інструкцій AVX цей застосунок наразі не працює.",
    ...
    "The app was installed successfully and will transcribe files in background processes on request." : "Застосунок було успішно встановлено. З його допомогою будуть розшифровуватися файли у фонових процесах за запитом.",
