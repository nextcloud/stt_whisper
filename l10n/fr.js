OC.L10N.register(
    ...
    "Small model (~1GB RAM, ~1x recording time, ~10-20% word error rate)" : "Petit modèle (~1 Go de RAM, ~1x temps d'enregistrement, taux d'erreur par mot de ~10-20%)",
    "Medium model (~2GB RAM, ~3x recording time, ~7-15% word error rate)" : "Modèle intermédiaire (~2 Go de RAM, ~3x le temps d'enregistrement,  taux d'erreur par mot de~7-15%)",
    "Large model (~3.5GB RAM, ~5x recording time, ~4-12% word error rate)" : "Grand modèle (~3.5 Go de RAM, ~5x le temps d'enregistrement, taux d'erreur par mot de~4-12%)",
