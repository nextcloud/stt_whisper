OC.L10N.register(
    ...
    "Small model (~1GB RAM, ~1x recording time, ~10-20% word error rate)" : "Malý model (~1GB RAM, ~1x doby nahrávky, ~10-20% četnost chybných slov)",
    "Medium model (~2GB RAM, ~3x recording time, ~7-15% word error rate)" : "Střední model (~2GB RAM, ~3x doba nahrávky, ~7-15% četnost chybných slov)",
    "Large model (~3.5GB RAM, ~5x recording time, ~4-12% word error rate)" : "Velký model (~3.5GB RAM, ~5x doby nahrávky, ~4-12% četnost chybných slov)",
