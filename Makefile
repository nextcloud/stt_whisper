...
all: main static build

whisper.cpp:
	git clone https://github.com/ggerganov/whisper.cpp.git

whisper.cpp/models/ggml-large.bin: whisper.cpp
	bash whisper.cpp/models/download-ggml-model.sh large

models/large: whisper.cpp/models/ggml-large.bin
	cp whisper.cpp/models/ggml-large.bin models/large

whisper.cpp/models/ggml-medium.bin: whisper.cpp
	bash whisper.cpp/models/download-ggml-model.sh medium

models/medium: whisper.cpp/models/ggml-medium.bin
	cp whisper.cpp/models/ggml-medium.bin models/medium

whisper.cpp/models/ggml-small.bin: whisper.cpp
	bash whisper.cpp/models/download-ggml-model.sh small

models/small: whisper.cpp/models/ggml-small.bin
	cp whisper.cpp/models/ggml-small.bin models/small
